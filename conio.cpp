...
namespace conio {
    ...
    // No Doxygen comments because internal function not intended to be called from outside the namespace.
    // Without the Doxygen comment block, does not get highlighted in the generated documentation.
    ...
    /** 
     * @brief Returns a string that contains the escape sequence to clear the screen.
     * @return A string containing the entire escape sequence to be output
