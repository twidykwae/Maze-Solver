...
/** 
 * @brief The conio namespace is a collection of functions that perform console I/O functions.
 */
namespace conio {
     ...
     *
     * Cannot use "enum class Color" because the values for the colors must have these specific values.
     */
    enum Color { 
        // Normal intensity
